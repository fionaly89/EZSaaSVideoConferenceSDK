...
typedef enum : NSUInteger {
    ...
    RTCLogActionType_share_desktop_startRecvImg, //开始下载图片
    RTCLogActionType_share_desktop_successRecvImg, //下载图片成功
    RTCLogActionType_share_desktop_failRecvImg, //下载图片失败
...
#pragma mark - my_nslog Action
- (void)addActionLogByLogs:(NSString *)resultBody;

#pragma mark - 0帧日志
- (void)enterScreenShare:(RoomNotify *)roomNotify;
- (void)leaveScreenShare:(RoomNotify *)roomNotify;
